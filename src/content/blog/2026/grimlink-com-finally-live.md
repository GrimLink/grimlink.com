...
Of course, since I built [Fylgja](https://fylgja.dev), it would have been a crime not to use it here. I've taken a strictly modular approach, pulling in only the essentials: the base defaults for consistency, design tokens for layout harmony, and a few utility classes for those final adjustments. The result is a site that feels snappy and stays true to the "pay only for what you use" architecture I advocate for.
